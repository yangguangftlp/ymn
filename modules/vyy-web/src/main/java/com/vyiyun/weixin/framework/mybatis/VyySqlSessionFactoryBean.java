 ...
 * 
 */
package com.vyiyun.weixin.framework.mybatis;
 ...
 * 
 */
public class VyySqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean,
		ApplicationListener<ApplicationEvent> {

	private static final Log logger = LogFactory.getLog(VyySqlSessionFactoryBean.class);
	...
	public Document configLocationMap() {
		...
		return doc;
		/*
		 * SAXReader saxReader = new SAXReader(); try { return
		 * saxReader.read(this.configLocation.getInputStream()); } catch
	...
	public void readXML(Resource configXML, final Element elementTypeAlias) {
		...
		saxReader.addHandler("/configuration/typeAliases/package", new ElementHandler() {
			public void onEnd(ElementPath path) {
				Element row = path.getCurrent();
				Element els = elementTypeAlias.addElement("package");
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		Document document = this.configLocationMap();
		Element root = document.getRootElement();
		Element elementTypeAlias = root.element("typeAliases");
		// 这里进行合并
		if (null != configLocation) {
			readXML(configLocation, elementTypeAlias);
		}
