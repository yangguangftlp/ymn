...
<div class="warp">
    <nav class="newSearchNav">
        <div class="clear newSearchBottom publicNav mainBg">
            <div class="newSearchHead whiteColor newSearchHeaderL">
                <b>未处理</b>
                <input type="checkbox">
                <i class="fa fa-angle-down projectIcon"></i>
            </div>
            <div class="newSearchHeaderC"></div>
            <div class="newSearchHead whiteColor centrallyLocated newSearchHeaderR">
...
<script src="js/mobile/loan/shAudit.js"></script>
</body>
</html>