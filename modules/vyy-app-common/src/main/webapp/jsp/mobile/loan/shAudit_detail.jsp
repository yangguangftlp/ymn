...
<body>
	<div class="warp">
		...
		<c:if test="${currentEA ne null }">
			<div class="btnGroup">
				<button type="button" class="warpBtn doubleBtn mainBg" id="sureBtn"
					entityAccountId="${currentEA.id }">通过</button>
				<button type="button" class="warpBtn doubleBtn grayBg"
					id="returnBtn" entityAccountId="${currentEA.id }">拒绝</button>
			</div>
		</c:if>
		<!-- 公共部分End -->
	</div>
	...
	<script src="js/mobile/loan/shAudit-detail.js"></script>
