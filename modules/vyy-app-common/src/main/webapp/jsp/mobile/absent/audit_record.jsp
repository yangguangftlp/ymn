	...
	<div class="warp">
		<nav class="newSearchNav">
			...
			<div class="whiteBg newSearchBottom switchCon myHide">
				<ul>
					<li class="newSearchBottom">待我审核<!--<i class="fa fa-check mainColor"></i>--></li>
					<li>我已审核</li>
					<!-- <li>全部状态</li> -->
				</ul>
			</div>
		...
		<section>
			<ul>
				<!-- <li class="twoLine"><header>
						<span>6月22日~6月23日</span> <span class="mainColor emphasisFont">年假</span>
						<span>5小时</span> <i class="fa fa-angle-right"></i>
					</header>
					<div class="subColor">申请人：某某某</div></li> -->
			</ul>
		</section>
	</div>
	<script src="js/jquery-1.8.3.min.js"></script>
	<script src="js/recordList.js"></script>
	<script src="js/mobile/absent/audit-record.js"></script>
