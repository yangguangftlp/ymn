...
<body>
	<div class="warp roomNameDetail">
		...
		<div class="selectPeople" id="selectAuditor">
			<div class="selectPeopleTit fgrayBg">参会人员：共邀请 ${eaListSize} 人</div>
		...
		<div class="btnGroup">
			<c:if test="${ meetingStatusDigit==1 && dealResult==0 }">
				<button type="button" class="singleBtn warpBtn blurBg"
					id="affirmBtn" data-url="">确认参加</button>
			</c:if>
			<c:if test="${currentUserType==0 && meetingStatusDigit==1 }">
	...
	<script src="js/mobile/meeting/meetingDetail.js"></script>
</body>
</html>
