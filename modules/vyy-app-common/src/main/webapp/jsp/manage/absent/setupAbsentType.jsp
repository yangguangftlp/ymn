...
<body class="frame-body">
	...
	<div class="app-set-fluid">
		<div class="tabbable tabbable-custom tabs-left">
			...
			<ul class="nav nav-tabs tabs-left">
				<li><a href="manage/absent/absentList.action">请假</a></li>
				<li class="active"><a href="manage/absent/setupAbsentType.action">请假类型设置</a></li>
			</ul>
			<div class="tab-content">
				<div class="tab-pane" style="display:block;">
					<!-- app manage -->
					<h5 class="set-hd-bar">
						<strong>请假类型设置</strong>
						<a href="javascript:location.reload();" class="pull-right" title="刷新"><i class="icon-refresh"></i></a>
						<a href="#" class="pull-right" title='添加'
							data-target="#addAbsentType" data-toggle="modal"><i
							class="icon-plus"></i></a>
					</h5>
					<hr>
	...
	<!-- END MY APP-->
	<!-- BEGIN MODAL-->
	<div id="addAbsentType" class="modal fade modal-absent-type"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">添加请假类型</h4>
				</div>
	...
	<script type="text/javascript" src="js/manage/absent/absent-manage.js"></script>
	<!-- END CORE PLUGINS -->
	<script>
		$(function() {
			absentType.init();
