	...
	<div class="app-set-fluid">
		<div class="tabbable tabbable-custom tabs-left">
			...
			<ul class="nav nav-tabs tabs-left">
				<li class="active"><a href="manage/absent/absentList.action">请假</a></li>
				<li><a  href="manage/absent/setupAbsentType.action">请假类型设置</a></li>
			</ul>
									...
									<div class="control-group">
										<div class="controls">
											<span><input type="text"
												class="m-wrap m-ctrl-medium date-picker" id="starttime"
												placeholder="开始时间"></span> <span>至</span> <span><input
												type="text" class="m-wrap m-ctrl-medium date-picker"
												id="endtime" placeholder="结束时间"></span>
										</div>
									</div>
									<div class="control-group">
										<div class="controls">
