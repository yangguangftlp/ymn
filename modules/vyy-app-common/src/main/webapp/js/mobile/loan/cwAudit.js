...
var listModule= 2,//0：只有状态选择，1：只有搜索，2：机油状态又有搜索
    ...
    unDealWithUrl="mobile/loan/getCwAuditRecord.action.action?time="+new Date().getTime(),//tab切换，未处理的请求url
    DealWithUrl="mobile/loan/getCwBeAuditRecord.action.action?time="+new Date().getTime(),//tab切换，已处理的请求url
//searchUrl="",//搜索的url
