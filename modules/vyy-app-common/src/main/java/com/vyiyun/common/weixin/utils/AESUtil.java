...
/**
 * @author tf AES 加密解密工具
 * @date 下午4:24:29
 */
public class AESUtil {
	public static void main(String[] args) throws Exception {
		String content = "PNZxTEFjl2Je7SHd9UqrpFnaCkJxRgLxy1FAkScicjQ";
		System.out.println("加密前：" + content);
		String key = "JsYkhl@2016";
		System.out.println("加密密钥和解密密钥：" + key);

		String encrypt = aesEncrypt(content, key);
		System.out.println("加密后：" + encrypt);

		String decrypt = aesDecrypt("M5SmBijjgImeJvNnS//kxBLL/ULOJpdznC5Udazb+mYThMO1n6dVODhfhx2O3g3W", key);
